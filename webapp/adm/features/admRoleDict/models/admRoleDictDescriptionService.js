(function () {
    angular.module("admApp")
        .factory("admRoleDictDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "admRoleDict";
			var serviceDescPural = "Справочники";
			var serviceDescSingular = "Справочник";
