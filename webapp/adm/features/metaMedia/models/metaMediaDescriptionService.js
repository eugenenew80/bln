(function () {
    angular.module("admApp")
        .factory("metaMediaDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "metaMedia";
			var serviceDescPural = "Данные";
			var serviceDescSingular = "Данные";
