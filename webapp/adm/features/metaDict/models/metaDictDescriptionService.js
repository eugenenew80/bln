(function () {
    angular.module("admApp")
        .factory("metaDictDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "metaDict";
			var serviceDescPural = "Меню модуля Справочники";
			var serviceDescSingular = "Меню модуля Справочники";
