angular.module("mediaApp")
	.controller("mediaDayMeteringDataOperListCtrl", function ($scope, $routeParams, $location, $mdDialog, $mdToast, $http, stateService, descriptionService, descriptionServices) {
        ...
        $scope.applySearch = function() {            
        	...
        	$scope.data.elements=dataService.calcByGroup(1, "2017-10-30");
