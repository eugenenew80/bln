(function () {
    angular.module("mediaApp")
        .factory("mediaDocUnderAccountingMeasLineDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "mediaDocUnderAccountingMeasLine";
