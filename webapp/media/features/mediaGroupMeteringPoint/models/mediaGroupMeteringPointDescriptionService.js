(function () {
    angular.module("mediaApp")
        .factory("mediaGroupMeteringPointDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "mediaGroupMeteringPoint";
            ...
            return {
                ...
                sections: {
                	...
                	header: {
                		path: {
                			type: "breadcrumb",
                			items: ["НСИ", "Группы", serviceDescPural],		
                		}
                	},
