(function () {
    angular.module("mediaApp")
        .factory("mediaGroupDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "mediaGroup";
			var serviceDescPural = "Группы";
			var serviceDescSingular = "Группы точек учёта";
