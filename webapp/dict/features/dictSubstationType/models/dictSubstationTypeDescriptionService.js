(function () {
    angular.module("dictApp")
        .factory("dictSubstationTypeDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictSubstationType";
			var serviceDescPural = "Типы подстанций";
			var serviceDescSingular = "Тип подстанции";
