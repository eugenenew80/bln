(function () {
    angular.module("dictApp")
        .factory("dictMeterTypeDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictMeterType";
			var serviceDescPural = "Типы счётчиков";
			var serviceDescSingular = "Тип счётчика";
