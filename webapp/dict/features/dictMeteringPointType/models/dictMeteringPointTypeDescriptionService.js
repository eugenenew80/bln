(function () {
    angular.module("dictApp")
        .factory("dictMeteringPointTypeDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictMeteringPointType";
			var serviceDescPural = "Типы точек учёта";
			var serviceDescSingular = "Тип точки учёта";
