(function () {
    angular.module("dictApp")
        .factory("dictCurrentTransTypeDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictCurrentTransType";
			var serviceDescPural = "Типы трансформаторов тока";
			var serviceDescSingular = "Тип трансформатора тока";
