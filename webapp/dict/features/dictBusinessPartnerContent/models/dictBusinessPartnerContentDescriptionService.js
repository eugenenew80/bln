(function () {
    angular.module("dictApp")
        .factory("dictBusinessPartnerContentDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictBusinessPartnerContent";
			var serviceDescPlural = "Файлы";
			var serviceDescSingular = "Файл";
            ...
            return {
                ...
                forms: {
                    ...
                    edit: {
                        type: "modalForm",
                        templateURL: "dict/features/dictBusinessPartnerContent/views/edit.html",
                        controller: "dictBusinessPartnerContentEditCtrl",
