(function () {
    angular.module("dictApp")
        .factory("dictDataSourceDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictDataSource";
			var serviceDescPural = "Источники данных";
			var serviceDescSingular = "Источник данных";
