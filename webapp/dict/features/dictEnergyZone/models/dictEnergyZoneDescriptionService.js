(function () {
    angular.module("dictApp")
        .factory("dictEnergyZoneDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictEnergyZone";
			var serviceDescPural = "Зоны энергосистемы";
			var serviceDescSingular = "Зона энергосистемы";
