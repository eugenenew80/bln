(function () {
    angular.module("dictApp")
        .factory("dictUnitDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {
        	
			var serviceName = "dictUnit";
			var serviceDescPural = "Единицы измерения";
			var serviceDescSingular = "Единица измерения";
