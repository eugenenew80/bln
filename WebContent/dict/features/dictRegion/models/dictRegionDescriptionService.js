(function () {
    angular.module("dictApp")
        .factory("dictRegionDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictRegion";
			var serviceDescPural = "Административные области";
			var serviceDescSingular = "Административная область";
