(function () {
    angular.module("dictApp")
        .factory("dictSubstationMeteringPointDescriptionService", function ($filter, dataServices, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {

			var serviceName = "dictSubstationMeteringPoint";
            ...
            return {
                ...
                sections: {
                	...
                	header: {
                		path: {
                			type: "breadcrumb",
                			items: ["НСИ", "Подстанции", serviceDescPural],		
                		}
                	},
