(function () {
    angular.module("admApp")
        .factory("admRoleDescriptionService", function ($filter, stateService, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {
