(function () {
    angular.module("admApp")
        .factory("admFuncDescriptionService", function ($filter, stateService, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {
